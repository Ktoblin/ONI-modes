...
namespace BleachStoneRefinery
{
    ...
    {
        public const string ID = "Ktoblin.SlimeRefinery";
        ...
        {
            Tag tag1 = SimHashes.ContaminatedOxygen.CreateTag();
            ...
            {
              new ElementConverter.OutputElement(0.6f, SimHashes.SlimeMold, 303.15f, storeOutput: true)
            };
